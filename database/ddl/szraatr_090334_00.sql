...
PROMPT
PROMPT ***   Creating SZRAATR  Table
PROMPT

DROP TABLE SZRAATR  CASCADE CONSTRAINTS;

REM *
REM * Create table SZRAATR .
REM ************************************************************************************************
START szraatr_090334_01.sql
START szraatr_090334_02.sql
START szraatr_090334_03.sql


REM *
REM * Grant BANINST1 ACCESS with GRANT OPTION.
REM ************************************************************************************************
GRANT ALL ON SZRAATR  TO BANINST1 WITH GRANT OPTION;

CONNECT baninst1/&&baninst1_password
SET ECHO OFF
SET SHOWMODE OFF

DROP PUBLIC SYNONYM SZRAATR ;

CREATE PUBLIC SYNONYM SZRAATR  FOR SATURN.SZRAATR ;
