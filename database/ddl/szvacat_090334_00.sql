...
PROMPT
PROMPT ***   Creating SZVACAT  Table
PROMPT

DROP TABLE SZVACAT  CASCADE CONSTRAINTS;

REM *
REM * Create table SZVACAT .
REM ************************************************************************************************
START szvacat_090334_01.sql
START szvacat_090334_02.sql
START szvacat_090334_03.sql


REM *
REM * Grant BANINST1 ACCESS with GRANT OPTION.
REM ************************************************************************************************
GRANT ALL ON SZVACAT  TO BANINST1 WITH GRANT OPTION;

CONNECT baninst1/&&baninst1_password
SET ECHO OFF
SET SHOWMODE OFF

DROP PUBLIC SYNONYM SZVACAT ;

CREATE PUBLIC SYNONYM SZVACAT  FOR SATURN.SZVACAT ;
