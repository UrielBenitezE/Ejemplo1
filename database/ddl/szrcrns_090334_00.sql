...
PROMPT
PROMPT ***   Creating SZRCRNS  Table
PROMPT

DROP TABLE SZRCRNS  CASCADE CONSTRAINTS;

REM *
REM * Create table SZRCRNS .
REM ************************************************************************************************
START szrcrns_090334_01.sql
START szrcrns_090334_02.sql
START szrcrns_090334_03.sql

REM *
REM * Grant BANINST1 ACCESS with GRANT OPTION.
REM ************************************************************************************************
GRANT ALL ON SZRCRNS  TO BANINST1 WITH GRANT OPTION;

CONNECT baninst1/&&baninst1_password
SET ECHO OFF
SET SHOWMODE OFF

DROP PUBLIC SYNONYM SZRCRNS ;

CREATE PUBLIC SYNONYM SZRCRNS  FOR SATURN.SZRCRNS ;
