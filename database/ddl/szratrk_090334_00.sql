...
PROMPT
PROMPT ***   Creating SZRATRK  Table
PROMPT

DROP TABLE SZRATRK  CASCADE CONSTRAINTS;

REM *
REM * Create table SZRATRK .
REM ************************************************************************************************
START szratrk_090334_01.sql
START szratrk_090334_02.sql
START szratrk_090334_03.sql


REM *
REM * Grant BANINST1 ACCESS with GRANT OPTION.
REM ************************************************************************************************
GRANT ALL ON SZRATRK  TO BANINST1 WITH GRANT OPTION;

CONNECT baninst1/&&baninst1_password
SET ECHO OFF
SET SHOWMODE OFF

DROP PUBLIC SYNONYM SZRATRK ;

CREATE PUBLIC SYNONYM SZRATRK  FOR SATURN.SZRATRK ;
