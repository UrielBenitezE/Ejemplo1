...
PROMPT
PROMPT ***   Creating SZREQIV  Table
PROMPT

DROP TABLE SZREQIV  CASCADE CONSTRAINTS;

REM *
REM * Create table SZREQIV .
REM ************************************************************************************************
START szreqiv_090334_01.sql
START szreqiv_090334_02.sql
START szreqiv_090334_03.sql


REM *
REM * Grant BANINST1 ACCESS with GRANT OPTION.
REM ************************************************************************************************
GRANT ALL ON SZREQIV  TO BANINST1 WITH GRANT OPTION;

CONNECT baninst1/&&baninst1_password
SET ECHO OFF
SET SHOWMODE OFF

DROP PUBLIC SYNONYM SZREQIV ;

CREATE PUBLIC SYNONYM SZREQIV  FOR SATURN.SZREQIV ;
