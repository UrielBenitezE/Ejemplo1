...
PROMPT
PROMPT ***   Creating SZRSCHM  Table
PROMPT

DROP TABLE SZRSCHM  CASCADE CONSTRAINTS;

REM *
REM * Create table SZRSCHM .
REM ************************************************************************************************
START szrschm_090334_01.sql
START szrschm_090334_02.sql
START szrschm_090334_03.sql


REM *
REM * Grant BANINST1 ACCESS with GRANT OPTION.
REM ************************************************************************************************
GRANT ALL ON SZRSCHM  TO BANINST1 WITH GRANT OPTION;

CONNECT baninst1/&&baninst1_password
SET ECHO OFF
SET SHOWMODE OFF

DROP PUBLIC SYNONYM SZRSCHM ;

CREATE PUBLIC SYNONYM SZRSCHM  FOR SATURN.SZRSCHM ;
