...
PROMPT
PROMPT ***   Creating SZRSATR  Table
PROMPT

DROP TABLE SZRSATR  CASCADE CONSTRAINTS;

REM *
REM * Create table SZRSATR .
REM ************************************************************************************************
START szrsatr_090334_01.sql
START szrsatr_090334_02.sql
START szrsatr_090334_03.sql


REM *
REM * Grant BANINST1 ACCESS with GRANT OPTION.
REM ************************************************************************************************
GRANT ALL ON SZRSATR  TO BANINST1 WITH GRANT OPTION;

CONNECT baninst1/&&baninst1_password
SET ECHO OFF
SET SHOWMODE OFF

DROP PUBLIC SYNONYM SZRSATR ;

CREATE PUBLIC SYNONYM SZRSATR  FOR SATURN.SZRSATR ;
