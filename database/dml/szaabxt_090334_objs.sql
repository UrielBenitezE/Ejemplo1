REM ************************************************************************************************
REM *                                                                                              *
REM * Script Name : szaabxt_090334_objs.sql                                                        *
REM *                                                                                              *
...
DELETE FROM GENERAL.GUBPAGE
      WHERE gubpage_code = 'SZAABXT';

DELETE general.gubobjs
       WHERE gubobjs_name = 'SZAABXT';
...
VALUES
      ('SZAABXT',
       G$_NLS.GET('X','SQL','Justificación de Ausencias'),
       'FORM',
       'S',
       'BANNER',
       SYSDATE,
