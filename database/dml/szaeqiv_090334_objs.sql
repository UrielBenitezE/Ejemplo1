REM ************************************************************************************************
REM *                                                                                              *
REM * Script Name : szaeqiv_090334_objs.sql                                                        *
REM *                                                                                              *
...
DELETE FROM GENERAL.GUBPAGE
      WHERE gubpage_code = 'SZAEQIV';

DELETE general.gubobjs
       WHERE gubobjs_name = 'SZAEQIV';
...
VALUES
      ('SZAEQIV',
       G$_NLS.GET('X','SQL','Configuración de Equivalencias en Historia Académica'),
       'FORM',
       'S',
       'BANNER',
       SYSDATE,
