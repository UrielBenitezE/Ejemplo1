REM ************************************************************************************************
REM *                                                                                              *
REM * Script Name : szagsma_090334_objs.sql                                                        *
REM *                                                                                              *
...
DELETE FROM GENERAL.GUBPAGE
      WHERE gubpage_code = 'SZAGSMA';

DELETE general.gubobjs
       WHERE gubobjs_name = 'SZAGSMA';
...
VALUES
      ('SZAGSMA',
       G$_NLS.GET('X','SQL','Asignación Masiva de Esquemas para NRC'),
       'FORM',
       'S',
       'BANNER',
       SYSDATE,
