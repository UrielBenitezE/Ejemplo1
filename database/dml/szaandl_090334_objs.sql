REM ************************************************************************************************
REM *                                                                                              *
REM * Script Name : szaandl_090334_objs.sql                                                        *
REM *                                                                                              *
...
DELETE FROM GENERAL.GUBPAGE
      WHERE gubpage_code = 'SZAANDL';

DELETE general.gubobjs
       WHERE gubobjs_name = 'SZAANDL';
...
VALUES
      ('SZAANDL',
       G$_NLS.GET('X','SQL','Cálculo de Ausencias y Límite de No Entegables'),
       'FORM',
       'S',
       'BANNER',
       SYSDATE,
