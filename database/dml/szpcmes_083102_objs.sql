...
REM ****************************************************************************
REM *                                                                          *
REM *  Script Name : szpcmes_083102_objs.sql                                   *
REM *                                                                          *
REM *      Project : UTM                                                       *
REM * Modification : 002 -               .                                     *
REM *  Description : Create SZPCMES JOB.                                       *
REM *                                                                          *
REM ****************************************************************************
REM *                                                                          *
REM *  AUDIT TRAIL: 8.7.0 [ITESM:002.1.0]                     INI    DATE      *
REM *  ------------------------------------------------------ --- ------------ *
REM * 1. Creacion del Codigo.                                 MDF 18/JAN/2016  *
REM *    --------------------                                                  *
...
PROMPT
PROMPT ************************************************
PROMPT *  Now running szpcmes_083102_objs.sql script  *
PROMPT ************************************************
PROMPT
...
SET SHOWMODE OFF
REM
START gsanobj SZPCMES BAN_DEFAULT_M '8.31.2' T BAN_STUDENT_C
...
DELETE GUBOBJS WHERE GUBOBJS_NAME = 'SZPCMES';
...
INSERT INTO GUBOBJS ( GUBOBJS_NAME          ,
             ...
             VALUES ( 'SZPCMES',
                      G$_NLS.GET('x','SQL','Massive Load of Schemas'),
                      'JOBS',
                      'S',
                      'LOCAL',
                      SYSDATE,
...
DELETE GJBJOBS WHERE GJBJOBS_NAME = 'SZPCMES';
...
DELETE GJBPDEF WHERE GJBPDEF_JOB = 'SZPCMES';
...
VALUES ( 'SZPCMES', '01', G$_NLS.GET('x', 'SQL', 'Header Layout'), 30, 'C', 'R', 'S', SYSDATE, NULL, NULL, G$_NLS.GET('x', 'SQL', 'File Header Name.'), NULL, NULL );
 
INSERT INTO GJBPDEF (GJBPDEF_JOB, GJBPDEF_NUMBER, GJBPDEF_DESC, GJBPDEF_LENGTH, GJBPDEF_TYPE_IND, GJBPDEF_OPTIONAL_IND, GJBPDEF_SINGLE_IND, GJBPDEF_ACTIVITY_DATE, GJBPDEF_LOW_RANGE, GJBPDEF_HIGH_RANGE, GJBPDEF_HELP_TEXT, GJBPDEF_VALIDATION, GJBPDEF_LIST_VALUES)
VALUES ( 'SZPCMES', '02', G$_NLS.GET('x', 'SQL', 'Activity Layout'), 30, 'C', 'R', 'S', SYSDATE, NULL, NULL, G$_NLS.GET('x', 'SQL', 'File Activity Name.'), NULL, NULL );
                                                                  
INSERT INTO GJBPDEF (GJBPDEF_JOB, GJBPDEF_NUMBER, GJBPDEF_DESC, GJBPDEF_LENGTH, GJBPDEF_TYPE_IND, GJBPDEF_OPTIONAL_IND, GJBPDEF_SINGLE_IND, GJBPDEF_ACTIVITY_DATE, GJBPDEF_LOW_RANGE, GJBPDEF_HIGH_RANGE, GJBPDEF_HELP_TEXT, GJBPDEF_VALIDATION, GJBPDEF_LIST_VALUES)
VALUES ( 'SZPCMES', '03', 'Enter Run Mode [A/U]', 1, 'C', 'R', 'S', SYSDATE, NULL, NULL, 'Enter Run Mode [A-Audit/U-Update]', NULL, NULL);
...
REM ****************************************************************************
DELETE GJBPDFT WHERE GJBPDFT_JOB = 'SZPCMES';


INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPCMES', '01', SYSDATE, NULL, NULL, NULL );

INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPCMES', '02', SYSDATE, NULL, NULL, NULL );

INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPCMES', '03', SYSDATE, NULL, 'A', NULL );

REM ****************************************************************************
REM Alta en Banner - Definicion de los valores validos de parametros
REM ****************************************************************************
DELETE GJBPVAL WHERE GJBPVAL_JOB = 'SZPCMES';

INSERT INTO GJBPVAL( GJBPVAL_JOB, GJBPVAL_NUMBER, GJBPVAL_VALUE, GJBPVAL_DESC, GJBPVAL_ACTIVITY_DATE )
VALUES ( 'SZPCMES', '03', 'A', 'Run Mode [(A)udit]', SYSDATE);

INSERT INTO GJBPVAL( GJBPVAL_JOB, GJBPVAL_NUMBER, GJBPVAL_VALUE, GJBPVAL_DESC, GJBPVAL_ACTIVITY_DATE )
VALUES ( 'SZPCMES', '03', 'U', 'Run Mode [(U)pdate]', SYSDATE);
