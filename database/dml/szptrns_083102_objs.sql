...
PROMPT
PROMPT ************************************************
PROMPT *  Now running szptrns_083102_objs.sql script  *
PROMPT ************************************************
PROMPT
...
SET SHOWMODE OFF
REM
START gsanobj SZPTRNS BAN_DEFAULT_M '8.31.2' S BAN_STUDENT_C
...
DELETE GUBOBJS WHERE GUBOBJS_NAME = 'SZPTRNS';
...
INSERT INTO GUBOBJS ( GUBOBJS_NAME          ,
             ...
             VALUES ( 'SZPTRNS',
                      G$_NLS.GET('x','SQL','Massive load of external equivalences for students'), 
                      'JOBS',
                      'S',
                      'LOCAL',
                      SYSDATE,
...
DELETE GJBJOBS WHERE GJBJOBS_NAME = 'SZPTRNS';
...
INSERT INTO GJBJOBS ( GJBJOBS_NAME         ,
                      ...
                      GJBJOBS_VALIDATION   )
             VALUES ( 'SZPTRNS',
                      G$_NLS.GET('x','SQL','Massive load ext equi students'), 
                      SYSDATE,
                      'S',
                      'C',
                      G$_NLS.GET('x','SQL','Massive load of external equivalences for students'),
...
DELETE GJBPDEF WHERE GJBPDEF_JOB = 'SZPTRNS';
...
VALUES ( 'SZPTRNS', '01', G$_NLS.GET('x', 'SQL', 'Layout'), 30, 'C', 'R', 'S', SYSDATE, NULL, NULL, G$_NLS.GET('x', 'SQL', 'File Name.'), NULL, NULL );
                                                                  
INSERT INTO GJBPDEF (GJBPDEF_JOB, GJBPDEF_NUMBER, GJBPDEF_DESC, GJBPDEF_LENGTH, GJBPDEF_TYPE_IND, GJBPDEF_OPTIONAL_IND, GJBPDEF_SINGLE_IND, GJBPDEF_ACTIVITY_DATE, GJBPDEF_LOW_RANGE, GJBPDEF_HIGH_RANGE, GJBPDEF_HELP_TEXT, GJBPDEF_VALIDATION, GJBPDEF_LIST_VALUES)
VALUES ( 'SZPTRNS', '02', 'Enter Run Mode [A/U]', 1, 'C', 'R', 'S', SYSDATE, NULL, NULL, 'Enter Run Mode [A-Audit/U-Update]', NULL, NULL);
                                   
REM ****************************************************************************
REM Alta en Banner - Definicion de los Valores por Omision de los Parametros
REM ****************************************************************************
DELETE GJBPDFT WHERE GJBPDFT_JOB = 'SZPTRNS';


INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPTRNS', '01', SYSDATE, NULL, NULL, NULL );

INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPTRNS', '02', SYSDATE, NULL, 'A', NULL );

REM ****************************************************************************
REM Alta en Banner - Definicion de los valores validos de parametros
REM ****************************************************************************
DELETE GJBPVAL WHERE GJBPVAL_JOB = 'SZPTRNS';

INSERT INTO GJBPVAL( GJBPVAL_JOB, GJBPVAL_NUMBER, GJBPVAL_VALUE, GJBPVAL_DESC, GJBPVAL_ACTIVITY_DATE )
VALUES ( 'SZPTRNS', '02', 'A', 'Run Mode [(A)udit/(U)pdate]', SYSDATE);

INSERT INTO GJBPVAL( GJBPVAL_JOB, GJBPVAL_NUMBER, GJBPVAL_VALUE, GJBPVAL_DESC, GJBPVAL_ACTIVITY_DATE )
VALUES ( 'SZPTRNS', '02', 'U', 'Run Mode [(A)udit/(U)pdate]', SYSDATE);
