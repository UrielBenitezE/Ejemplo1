REM ************************************************************************************************
REM *                                                                                              *
REM *  Script Name : szvsaca_090334_objs.sql                                                       *
REM *                                                                                              * 
REM *      Project : UTM                                                                           *
...
DELETE FROM GENERAL.GUBPAGE
      WHERE gubpage_code = 'SZVSACA';

DELETE general.gubobjs
       WHERE gubobjs_name = 'SZVSACA';
...
VALUES
      ('SZVSACA',
       G$_NLS.GET('X','SQL','Validación de Esquemas'),
       'FORM',
       'S',
       'BANNER',
       SYSDATE,
