...
REM *  --------------------------------------------------------------------------- --- ----------- *
REM * 1. Creacion del Codigo.                                                      MKU  26/NOV/2015*
REM *    --------------------                                                                      *
...
PROMPT
PROMPT ************************************************
PROMPT *  Now running szpcasc_083102_objs.sql script  *
PROMPT ************************************************
PROMPT
...
SET SHOWMODE OFF
REM
START gsanobj SZPCASC BAN_DEFAULT_M '8.31.2' S BAN_STUDENT_C
...
DELETE GUBOBJS WHERE GUBOBJS_NAME = 'SZPCASC';
...
INSERT INTO GUBOBJS ( GUBOBJS_NAME          ,
             ...
             VALUES ( 'SZPCASC',
                      G$_NLS.GET('x','SQL','Mass assignment for Without Qualification concept'), --TODO
                      'JOBS',
                      'S',
                      'LOCAL',
                      SYSDATE,
...
DELETE GJBJOBS WHERE GJBJOBS_NAME = 'SZPCASC';
...
INSERT INTO GJBJOBS ( GJBJOBS_NAME         ,
                      ...
                      GJBJOBS_VALIDATION   )
             VALUES ( 'SZPCASC',
                      G$_NLS.GET('x','SQL','Mass assignment for SC concept'), --TODO
                      SYSDATE,
                      'S',
                      'C',
                      G$_NLS.GET('x','SQL','Mass assignment for Without Qualification concept'), --TODO
...
DELETE GJBPDEF WHERE GJBPDEF_JOB = 'SZPCASC';
...
DELETE GJBPDFT WHERE GJBPDFT_JOB = 'SZPCASC';

INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPCASC', '01', SYSDATE, NULL, NULL, NULL );

INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPCASC', '02', SYSDATE, NULL, NULL, NULL );

INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPCASC', '03', SYSDATE, NULL, NULL, NULL );

INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPCASC', '04', SYSDATE, NULL, NULL, NULL );

INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPCASC', '05', SYSDATE, NULL, NULL, NULL );

INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPCASC', '06', SYSDATE, NULL, NULL, NULL );

INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPCASC', '07', SYSDATE, NULL, null, NULL );

INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPCASC', '08', SYSDATE, NULL, 'SC', NULL );

INSERT INTO GJBPDFT( GJBPDFT_JOB, GJBPDFT_NUMBER, GJBPDFT_ACTIVITY_DATE, GJBPDFT_USER_ID, GJBPDFT_VALUE, GJBPDFT_JPRM_CODE )
VALUES ( 'SZPCASC', '09', SYSDATE, NULL, 'A', NULL );
