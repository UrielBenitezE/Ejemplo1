REM ************************************************************************************************
REM *                                                                                              *
REM * Script Name : szaflda_090334_objs.sql                                                        *
REM *                                                                                              *
...
DELETE FROM GENERAL.GUBPAGE
      WHERE gubpage_code = 'SZALFDA';

DELETE general.gubobjs
       WHERE gubobjs_name = 'SZALFDA';
...
VALUES
      ('SZALFDA',
       G$_NLS.GET('X','SQL','Reglas para Límite de Ausencias y Guías Académicas'),
       'FORM',
       'S',
       'BANNER',
       SYSDATE,
