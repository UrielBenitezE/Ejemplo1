REM ************************************************************************************************
REM *                                                                                              *
REM * Script Name : szaschc_090334_objs.sql                                                        *
REM *                                                                                              *
...
DELETE FROM GENERAL.GUBPAGE
      WHERE gubpage_code = 'SZASCHC';

DELETE general.gubobjs
       WHERE gubobjs_name = 'SZASCHC';
...
VALUES
      ('SZASCHC',
       G$_NLS.GET('X','SQL','Copia de Esquemas por Periodo'),
       'FORM',
       'S',
       'BANNER',
       SYSDATE,
