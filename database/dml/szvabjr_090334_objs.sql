REM ************************************************************************************************
REM *                                                                                              *
REM *  Script Name : szvabjr_090334_objs.sql                                                       *
REM *                                                                                              * 
REM *      Project : UTM                                                                           *
REM * Modification : 002 - Mejora a asistencia, calificaciones e historia academica                *
REM *                                                                                              *
REM * Description: Este script da de alta objetos en Banner.                                       *
REM *                                                                                              *
REM ************************************************************************************************
REM *                                                                                              *
...
DELETE FROM GENERAL.GUBPAGE
      WHERE gubpage_code = 'SZVABJR';

DELETE general.gubobjs
       WHERE gubobjs_name = 'SZVABJR';
...
VALUES
      ('SZVABJR',
       G$_NLS.GET('X','SQL','Justificacion y Extension de Ausencias'),
       'FORM',
       'S',
       'BANNER',
       SYSDATE,
...
PROMPT
PROMPT *********************************************************************************************
PROMPT * End: szvabjr_090334_objs.sql                                                              *
PROMPT *********************************************************************************************
PROMPT
REM *
REM * End.
