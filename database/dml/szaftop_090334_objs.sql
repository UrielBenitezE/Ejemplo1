REM ************************************************************************************************
REM *                                                                                              *
REM * Script Name : szaftop_090334_objs.sql                                                        *
REM *                                                                                              *
...
DELETE FROM GENERAL.GUBPAGE
      WHERE gubpage_code = 'SZAFTOP';

DELETE general.gubobjs
       WHERE gubobjs_name = 'SZAFTOP';
...
VALUES
      ('SZAFTOP',
       G$_NLS.GET('X','SQL','Apertura de Captura de Calificaciones de Examen Final'),
       'FORM',
       'S',
       'BANNER',
       SYSDATE,
