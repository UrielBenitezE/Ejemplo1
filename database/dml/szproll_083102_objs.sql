...
REM ****************************************************************************
REM *                                                                          *
REM *  Script Name : szproll_083102_objs.sql                                   *
REM *                                                                          *
REM *      Project : UTM                                                       *
...
REM *  ------------------------------------------------------ --- ------------ *
REM * 1. Creacion del Codigo.                                 MSO 15/ENE/2016  *
REM *    --------------------                                                  *
...
PROMPT
PROMPT ************************************************
PROMPT *  Now running szproll_083102_objs.sql script  *
PROMPT ************************************************
PROMPT
...
SET SHOWMODE OFF
REM
START gsanobj SZPROLL BAN_DEFAULT_M '8.31.2' T BAN_STUDENT_C
...
DELETE GUBOBJS WHERE GUBOBJS_NAME = 'SZPROLL';
...
INSERT INTO GUBOBJS ( GUBOBJS_NAME          ,
             ...
             VALUES ( 'SZPROLL',
                      G$_NLS.GET('x','SQL','Grade Roll File Upload'),
                      'JOBS',
                      'S',
                      'LOCAL',
                      SYSDATE,
...
DELETE GJBJOBS WHERE GJBJOBS_NAME = 'SZPROLL';
...
DELETE GJBPDEF WHERE GJBPDEF_JOB = 'SZPROLL';
...
VALUES ( 'SZPROLL', '01', G$_NLS.GET('x', 'SQL', 'Layout'), 30, 'C', 'O', 'S', SYSDATE, NULL, NULL, G$_NLS.GET('x', 'SQL', 'File Name.'), NULL, NULL );
                                                                  
INSERT INTO GJBPDEF (GJBPDEF_JOB, GJBPDEF_NUMBER, GJBPDEF_DESC, GJBPDEF_LENGTH, GJBPDEF_TYPE_IND, GJBPDEF_OPTIONAL_IND, GJBPDEF_SINGLE_IND, GJBPDEF_ACTIVITY_DATE, GJBPDEF_LOW_RANGE, GJBPDEF_HIGH_RANGE, GJBPDEF_HELP_TEXT, GJBPDEF_VALIDATION, GJBPDEF_LIST_VALUES)
VALUES ( 'SZPROLL', '02', 'Enter Run Mode [A/U]', 1, 'C', 'R', 'S', SYSDATE, NULL, NULL, 'Enter Run Mode [A-Audit/U-Update]', NULL, NULL);
