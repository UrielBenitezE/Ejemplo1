REM ****************************************************************************
REM *                                                                          *
REM * szpeqiv_083102_objs.sql                                                  *
REM * Copyright 2016 Ellucian Company L.P. and its affiliates.                 *
REM *                                                                          *
REM ****************************************************************************
REM *                                                                          *
...
REM ****************************************************************************
REM *                                                                          *
REM *  Script Name : szpeqiv_083102_objs.sql                                   *
REM *                                                                          *
REM *      Project : UTM                                                       *
REM * Modification : 002 -               .                                     *
REM *  Description : Create SZPEQIV JOB.                                       *
REM *                                                                          *
REM ****************************************************************************
REM *                                                                          *
REM *  AUDIT TRAIL: 8.7.0 [ITESM:002.1.0]                     INI    DATE      *
REM *  ------------------------------------------------------ --- ------------ *
REM * 1. Creacion del Codigo.                                 MDF 27/JAN/2016  *
REM *    --------------------                                                  *
...
PROMPT
PROMPT ************************************************
PROMPT *  Now running szpeqiv_083102_objs.sql script  *
PROMPT ************************************************
PROMPT
...
SET SHOWMODE OFF
REM
START gsanobj SZPEQIV BAN_DEFAULT_M '8.31.2' T BAN_STUDENT_C
...
DELETE GUBOBJS WHERE GUBOBJS_NAME = 'SZPEQIV';
...
INSERT INTO GUBOBJS ( GUBOBJS_NAME          ,
             ...
             VALUES ( 'SZPEQIV',
                      G$_NLS.GET('x','SQL','Massive Load of Internal Equivalences for the student'),
                      'JOBS',
                      'S',
                      'LOCAL',
                      SYSDATE,
...
DELETE GJBJOBS WHERE GJBJOBS_NAME = 'SZPEQIV';
...
INSERT INTO GJBJOBS ( GJBJOBS_NAME         ,
                      ...
                      GJBJOBS_VALIDATION   )
             VALUES ( 'SZPEQIV',
                      G$_NLS.GET('x','SQL','Massive Load of Internal Equiv'),
                      SYSDATE,
                      'S',
                      'C',
                      G$_NLS.GET('x','SQL','Massive Load of Internal Equivalences for the student'),
...
DELETE GJBPDEF WHERE GJBPDEF_JOB = 'SZPEQIV';
...
VALUES ( 'SZPEQIV', '01', G$_NLS.GET('x', 'SQL', 'Layout'), 30, 'C', 'R', 'S', SYSDATE, NULL, NULL, G$_NLS.GET('x', 'SQL', 'File Name.'), NULL, NULL );
                                                                  
INSERT INTO GJBPDEF (GJBPDEF_JOB, GJBPDEF_NUMBER, GJBPDEF_DESC, GJBPDEF_LENGTH, GJBPDEF_TYPE_IND, GJBPDEF_OPTIONAL_IND, GJBPDEF_SINGLE_IND, GJBPDEF_ACTIVITY_DATE, GJBPDEF_LOW_RANGE, GJBPDEF_HIGH_RANGE, GJBPDEF_HELP_TEXT, GJBPDEF_VALIDATION, GJBPDEF_LIST_VALUES)
VALUES ( 'SZPEQIV', '02', 'Enter Run Mode [A/U]', 1, 'C', 'R', 'S', SYSDATE, NULL, NULL, 'Enter Run Mode [A-Audit/U-Update]', NULL, NULL);
